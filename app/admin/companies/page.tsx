              ...
              {companies.length === 0 ? (
                <tr>
                  <td colSpan={5} className="px-6 py-10 text-center text-muted-foreground">
                    <p>No companies yet. Add your first company profile for this section.</p>
                    <Link href="/admin/companies/create" className="mt-3 inline-block text-primary hover:underline">Create first company</Link>
                  </td>
                </tr>
              ) : null}
            </tbody>
